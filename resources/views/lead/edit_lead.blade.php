          ...
          <div class="col-md-6">
            ...
            <div class="col-md-4">
              ...
              <select id="inputState" class="form-select" name="lead-source">
                ...
                <option selected>{{ $lead_source }}</option>
                @else
            ...
            <h5 class="card-title">Description information</h5>
              ...
              <textarea class="form-control" id="inputDescription" value="{{$lead->lead_description}}" name="lead-description" rows=5>{{$lead->lead_description}}</textarea>
            </div>
